...
public class SanctionLetterGenerator implements PDFGenerator {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SanctionLetterGenerator.class);
    ...
    @Value("${sanctionletter.template.name}")
    ...
    public void validateData(Map<String, Object> data) {
        logger.info("Validating the Sanction Letter Data");
        if (data == null) {
